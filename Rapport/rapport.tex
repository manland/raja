...
Nous avons mise en place un fabrique pour nous faciliter la création des divers objets : base de donnée, requête, traducteur et adaptateurs. En effet chaque instance de ces objets seront presques équivalentes. Les différences seront chargées par le biais d'un fichier xml ce qui permetra de paramétrer notre système.

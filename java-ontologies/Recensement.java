...
public class Recensement {
	...
	public static void main( String[] args ) {
		...
		"SELECT ?mal ?pays ?zone ?date ?nb WHERE {?mal rdf:type rec:MALADIE . ?mal rec:RM_LIBELLE_PAYS ?pays . ?pays rec:RP_LIBELLE_ZO ?zone . ?mal rec:RM_ID_RECENSEMENT ?re . ?re rec:RR_ANNEE ?date . ?mal rec:RM_POPULATION ?nb}" ;
